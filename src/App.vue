<template>
  <div id="app">
    ...
    <div class="bg-wrapper">
      <div class="bg" v-parallax.modifier="0.5"></div>
    </div>
    <div class="site">
      <header>
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-12 more-pad d-flex align-items-center justify-content-sm-between nav-wrap">
              <ul class="nav">
                ...
                <router-link tag="li" class="nav-item" to="/accounts" active-class="active">
                  <a>Accounts</a>
                </router-link>
              </ul>
              <button class="button button-main button-discord" @click="showModal = true">
